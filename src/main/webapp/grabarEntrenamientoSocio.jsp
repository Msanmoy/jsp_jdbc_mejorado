...
<%
    ...
    try {
        ...
        System.out.println(String.valueOf(Objects.requireNonNull(request.getParameter("tipo"))));
        ...
        if (!request.getParameter("tipo").equalsIgnoreCase("fisico") && !request.getParameter("tipo").equalsIgnoreCase("tecnico")) throw new RuntimeException("No válido");
